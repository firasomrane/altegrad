...
path_to_output_images = path_root + 'output/'
...
if not is_prod:
    ...
    # model.evaluateAndShowAttention('The cat fell asleep on the mat.', path_to_output_images)
    # model.evaluateAndShowAttention('I have a red car', path_to_output_images)
